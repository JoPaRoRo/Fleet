...
public class ReporteDao {
    ...
    public ArrayList<ReporteRespuesta> generarReporteMontacargas(Reporte reporte) throws SQLException {
        ...
        for (Montacargas mt : reporte.getMontacargas()) {
            ...
            cs.setString(2, dt.format(reporte.FechaInicial));
            cs.setString(3, dt.format(reporte.FechaFinal));
            rs = cs.executeQuery();
            rs.next();
            ...
            cs.setString(1, mt.getNumero_serie());
            cs.setFloat(2, dolar);
            cs.setString(3, dt.format(reporte.FechaInicial));
            cs.setString(4, dt.format(reporte.FechaFinal));
            rs = cs.executeQuery();
            rs.next();
    ...
    public ArrayList<Detalle> generarDetalleMontacargas(Reporte reporte) throws SQLException {
        ...
        cs.setString(2, reporte.getFechaFinal());
    ...
    public String generarDetalleContrato(Reporte reporte) {
        return null;
    }

    public String generarDetalleProyecto(Reporte reporte) {
        return null;
    }
